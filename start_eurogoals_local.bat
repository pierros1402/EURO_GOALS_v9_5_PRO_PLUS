@echo off
title EURO_GOALS PRO+ — Local Control Panel v3
color 0B
...
:: ==========================================================
:: EURO_GOALS PRO+ — Local Control Panel v3 (Live Status)
:: ==========================================================
...
echo.
echo ==========================================================
echo      %APPNAME% — Local Control Panel  [v%VERSION%]
echo ==========================================================
...
cls
echo ==========================================================
echo  [STARTING SERVER] %APPNAME% v%VERSION%
echo ==========================================================
